        ...
        <div class="col-lg-12">
            ...
            <div
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-widget17" style="background:gray">
                        <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides"
                            ...
                            <div class="kt-widget17__chart" style="height:320px; background:gray;">
                                <canvas id="kt_chart_activities"></canvas>
                            </div>
                        </div>
                        <div class="kt-widget17__stats" style="bottom:100px">
                            <div class="kt-widget17__items">
                                ...
                                <div class="kt-widget17__item">
                                    ...
                                    <span class="kt-widget17__desc">
                                        {{ count(\App\Models\Developer::all()) }}
                                    </span>
                                </div>
                            </div>
                            <div class="kt-widget17__items">
