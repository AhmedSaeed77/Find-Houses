        ...
        <form action="{{route('pro.addproject')}}" method="POST" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <div class="kt-input-icon">
                            <input type="file" name="images[]" class="form-control" placeholder="  ادخل الصور " required multiple>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <div class="kt-input-icon">
                            <input type="text" name="link1" class="form-control" placeholder="  ادخل اللينك الاول " required>
                        </div>
                    </div>
                    <label class="col-lg-2 col-form-label"> لينك الفيديو الثانى:</label>
                    <div class="col-lg-3">
                        <div class="kt-input-icon">
                            <input type="text" name="link2" class="form-control" placeholder="  ادخل اللينك الثانى " required >
                        </div>
                    </div>
                </div>
