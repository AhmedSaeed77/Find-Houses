...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet p-5" >
        ...
        <div class="row">
            <div class="col-lg-10">
                <a class="btn btn-primary " href="{{ route('status.createStatus') }}"> اضافه حاله جديد </a>
            </div>
        </div>
    </div>
</div>
        ...
        var KTDatatablesDataSourceAjaxServer = function() {
            var initTable1 = function() {
                ...
                table.DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('status.statusDatatable') }}",
                        data: function(d) {
                            d.name = $('#name').val();
                            d.owner = $('#owner').val();
                        }
                ...
                $('#kt_table_1 tbody').on('click', '.delete', function() {
                    ...
                    console.log(value)
                    Swal.fire({
                        title: ' سيتم مسح الحاله بكافة سنداتها ان وجد   ',
