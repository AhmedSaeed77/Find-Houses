            ...
            <div class="container">
                ...
                <div class="row featured portfolio-items">
                    ...
                    <div class="col-lg-8 col-md-12 homes-content pb-0 mb-44" data-aos="fade-up" >
                        <!-- homes address -->
                        <h3><a href="">{{ $pro->compound }}</a></h3>
                        <p class="homes-address mb-3">
                            <a href="">
                                <i class="fa fa-map-marker"></i><span>{{ $pro->compound }}</span>
                            </a>
                        </p>
                        <!-- homes List -->
                        <ul class="homes-list clearfix pb-3">
                            <li class="the-icons">
                                ...
                                <span>{{ $pro->compound }} {{ __('messages.Bedrooms') }} </span>
                            </li>
                            <li class="the-icons">
                                <i class="flaticon-bathtub mr-2" aria-hidden="true"></i>
                                <span>{{ $pro->compound }} {{ __('messages.Bathrooms') }} </span>
                            </li>
                            <li class="the-icons">
                            ...
                            <li class="the-icons">
                                ...
                                <span>{{ $pro->compound }} {{ __('messages.Garages') }} </span>
                            </li>
                        </ul>
                    </div>
