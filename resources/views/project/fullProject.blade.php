                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="{{ url('/')}}">{{ __('messages.Home') }} </a> &nbsp;/&nbsp; <span>{{ __('messages.Listings') }}</span></p>
                                </div>
                                <h3>{{ __('messages.List View') }} </h3>
                            </div>
                        </div>
                    </div>
                </section>
                 ...
                 @foreach ($projects as $pro)
                    ...
                    <div class="col-lg-8 col-md-12 homes-content pb-0 mb-44" data-aos="fade-up" >
                        ...
                        <p class="homes-address mb-3">
                            @foreach (\App\Models\Place::all() as $plc)
                                @if($plc->id == $pro->place_id)
                                    <a href="{{ route('project',$pro->id) }}">
                                    <i class="fa fa-map-marker"></i><span>{{ $plc->compname }}</span>
                                    </a>
                                @endif
                            @endforeach
                        </p>
                        ...
                        <ul class="homes-list clearfix pb-3">
                            <li class="the-icons">
                                ...
                                <span>{{ $pro->parking_fee }} Parking Fee </span>
                            </li>
                            <li class="the-icons">
                                <i class="flaticon-bathtub mr-2" aria-hidden="true"></i>
                                <span>{{ $pro->club_fee }} Club Fee </span>
                            </li>
                            <li class="the-icons">
                                <i class="flaticon-square mr-2" aria-hidden="true"></i>
                                <span>{{$pro->size}} Size</span>
                            </li>
                            <li class="the-icons">
                                <i class="flaticon-car mr-2" aria-hidden="true"></i>
                                <span>{{ $pro->downpaynment }}  Down Paynment </span>
                            </li>
                        </ul>
                            ...
                            <div class="project-inner project-head">
                                <div class="homes">
                                    ...
                                    <a href="single-property-1.html" class="homes-img">
                                        <div class="homes-tag button sale rent">{{ __('messages.For Rent') }}</div>
                                        <div class="homes-price">{{ $pro->compound }}</div>
                                        <img src="{{ url('/') . '/images/pro/' . $pro->image }}" alt="home-1" class="img-responsive">
                                    </a>
                                </div>
