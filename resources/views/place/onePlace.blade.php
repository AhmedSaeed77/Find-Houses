        ...
        <section class="headings">
            <div class="text-heading text-center">
                <div class="container">
                    ...
                    <h2><a href="{{route('main')}}">{{ __('messages.Home') }} </a> &nbsp;/&nbsp; {{ $place->compname }} {{ __('messages.Details') }} </h2>
                </div>
            </div>
        </section>
                                ...
                                <div class="news-item details no-mb2">
                                    <a href="" class="news-img-link">
                                        <div class="news-item-img">
                                            <img class="img-responsive" src="{{ asset('images/plc/'.$place->compimage ) }}" alt="blog image">
                                        </div>
                                    </a>
                                    <div class="news-item-text details pb-0">
                                        <a href=""><h3>{{ $place->compname }}</h3></a>
                                        <div class="dates">
